...
const agents: AgentCard[] = [
  ...
  },
  {
    ...
    description: 'Automate tickets, resolve customer queries, and manage multi-channel conversations with a fully autonomous AI support agent. Handle WhatsApp, Email, Live Chat, Voice, and Social Media — all unified in one dashboard. Connect with Jira, Zendesk, HubSpot, Salesforce, Slack, and Linear. Auto-route complex cases to human agents with full conversation context. Reduce response times from hours to seconds with 24/7 AI resolution.',
    video: healthcareVideo,
    color: '#9333EA',
    features: [
      'AI Ticket Automation',
      'Multi-Channel Support (WhatsApp, Email, Chat, Voice, Social)',
      'CRM & Tool Integrations (Jira, Zendesk, HubSpot, Salesforce, Slack, Linear)',
      'Smart Escalations with full conversation context',
      '24/7 AI Resolution',
      'Multilingual Support (Arabic + English + custom)',
      'Easy Embed - Deploy on your website in minutes'
    ]
  }
];
                    ...
                    {!isVideoRight ? (
                      <>
                        ...
                        <div className="agent-content-panel-stacked">
                          ...
                          >
                            {agent.id === 'agent-4' ? 'Explore Customer Support Agent' : `More About ${agent.name}`}
                          </button>
                        </div>
                      </>
                    ) : (
