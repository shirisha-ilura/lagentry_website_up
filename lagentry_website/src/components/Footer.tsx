          ...
          <div className="footer-sections-grid">
            ...
            <div className="footer-section">
              ...
              <ul className="footer-links">
                <li><a href="https://docs.lagentry.com" target="_blank" rel="noopener noreferrer" className="footer-link">Documentation</a></li>
                <li><a href="https://docs.lagentry.com/tutorials" target="_blank" rel="noopener noreferrer" className="footer-link">Tutorials</a></li>
                <li><a href="mailto:info@lagentry.com" className="footer-link">Support</a></li>
              </ul>
            </div>
            ...
            <div className="footer-section">
              ...
              <ul className="footer-links">
                ...
                <li><a href="/waitlist" onClick={(e) => { e.preventDefault(); navigate('/waitlist'); }} className="footer-link">Join the Waitlist</a></li>
              </ul>
            </div>
            ...
            <div className="footer-section">
              ...
              <ul className="footer-links">
                <li><a href="mailto:info@lagentry.com?subject=Privacy Policy Inquiry" className="footer-link">Privacy Policy</a></li>
                <li><a href="mailto:info@lagentry.com?subject=Terms of Service Inquiry" className="footer-link">Terms of Service</a></li>
              </ul>
            </div>
          </div>
        </div>
