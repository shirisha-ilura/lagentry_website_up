...
const AdminChats: React.FC = () => {
  ...
  const handleTakeover = async () => {
    ...
    try {
      const response = await fetch(`/api/admin/chat/${selectedConversation}?action=takeover`, {
        method: 'POST',
        headers: {
  ...
  const handleRelease = async () => {
    ...
    try {
      const response = await fetch(`/api/admin/chat/${selectedConversation}?action=release`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const handleSendReply = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(`/api/admin/chat/${selectedConversation}?action=reply`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
